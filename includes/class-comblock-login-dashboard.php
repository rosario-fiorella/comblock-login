...
class Comblock_Login_Dashboard {
	...
	public function add_meta_boxes(): void {
		add_meta_box( 'roles_metabox', __( 'Select Roles', 'comblock-login' ), array( $this, 'render_metabox_roles' ), self::POST_TYPE_SLUG, 'side' );
		add_meta_box( 'login_page_metabox', __( 'Select Login Page', 'comblock-login' ), array( $this, 'render_metabox_login_page' ), self::POST_TYPE_SLUG, 'side' );
	}
